        ...
        <section className="relative min-h-screen flex items-center justify-center">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-5xl mx-auto px-4 py-20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#inner-peace"
                className="bg-white/60 hover:bg-[#bdbdbaef] text-slate-900 border border-[#575755ef] text-sm mt-22 px-2 py-2 rounded-full font-semibold shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#7bbfa3] cursor-pointer"
              >
                Explore My Books
              </a>
            </div>
